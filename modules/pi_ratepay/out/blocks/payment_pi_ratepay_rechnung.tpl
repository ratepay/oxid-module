    ...
    <dt>
        ...
        <label for="payment_[{$sPaymentID}]"><b>
            [{if !$pi_ratepay_rechnung_whitelabel}]
                <img src="[{$oViewConf->getModuleUrl('pi_ratepay')}]out/blocks/img/pi_ratepay_rechnung_checkout_logo.png" title="RatePAY [{oxmultilang ident="PI_RATEPAY_RECHNUNG_VIEW_WHITELABEL_TEXT"}]" alt="RatePAY [{oxmultilang ident="PI_RATEPAY_RECHNUNG_VIEW_WHITELABEL_TEXT"}]" />
            [{else}]
