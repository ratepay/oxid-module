    ...
    <dt>
        ...
        <label for="payment_[{$sPaymentID}]"><b>
            [{if !$pi_ratepay_rate_whitelabel}]
                <img src="[{$oViewConf->getModuleUrl('pi_ratepay')}]out/blocks/img/pi_ratepay_rate_checkout_logo.png" title="RatePAY [{oxmultilang ident="PI_RATEPAY_RATE_VIEW_WHITELABEL_TEXT"}]" alt="RatePAY [{oxmultilang ident="PI_RATEPAY_RATE_VIEW_WHITELABEL_TEXT"}]" style="height: 40px" />
            [{else}]
